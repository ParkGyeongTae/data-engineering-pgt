...
st.set_page_config(page_title="KOSPI 시가총액 상위 20개", layout="wide")
st.title("📊 KOSPI 시가총액 상위 20개")
df = pd.read_csv(
    "stock_analysis/20251010_종목별시가총액/KOSPI_오늘기준_시가총액_상위20개_20251010.csv",
)
